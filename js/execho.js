...
function oEcho(){
	...
	this.consigne = "Consigne..."; // Fichier audio sans son extension : par ex. 'ma_dictee'
	this.saisie;
...
oEcho.prototype.corrige = function() {
	if ( this.saisie.length > 0 ){
		...
		apprise ("Veuillez d'abord saisir le texte !");
		return -1;
	}
}
...
// Obtenir les arguments passés avec l'url du fichier
